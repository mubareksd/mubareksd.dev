...
const projects = [
  ...
  },
  {
    ...
    description:
      'A collaborative task management tool for teams with real-time updates.',
    ...
    <section id="projects" className="container py-12">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        {projects.map((project, index) => (
          <Card
            key={index}
            className="bg-card/50 backdrop-blur supports-[backdrop-filter]:bg-background/60 border-primary/10 hover:border-primary/30 transition-colors overflow-hidden group"
          >
            <CardHeader>
